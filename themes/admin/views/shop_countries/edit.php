...
<div id="subnav"> 
			...
			<div id="mainbody" class="with-subnav"> 
				<h2 class="form-head">Edit Country</h2>
				<?php echo partial('validation'); ?>
				<?php echo form_open('admin/shop_countries/update'); ?>
				<?php echo form_hidden('id', $country->id); ?>
					...
					<div class="form-row">
						...
						&euro;<?php echo form_input('postage', $country->postage); ?>
					</div>
